...
# =============================================================================
# Camera Placement Problem (same as compare_optimizers.py)
# =============================================================================
...
def plot_overall_ranking(all_results: Dict[str, Dict], output_path: str):
    ...
    # Compute average coverage per method
    avg_coverage = {}
    ...
    for i, (bar, avg) in enumerate(zip(bars, avgs)):
        ...
        medals = ['🥇', '🥈', '🥉']
        if i < 3:
            ax.text(1, bar.get_y() + bar.get_height()/2, medals[i],
...
def run_benchmark(
    ...
    print("=" * 70)
    print("MULTI-TOPOLOGY OPTIMIZER BENCHMARK")
    print("=" * 70)
    ...
    # Run benchmark on each topology
    all_results = {}
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Benchmark optimizers across DEM topologies')
